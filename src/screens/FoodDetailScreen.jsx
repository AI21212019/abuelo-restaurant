              ...
              <div className="order-2 md:order-1 lg:order-1 flex flex-col justify-center">
                ...
                <div className="mt-8 flex items-center justify-center md:justify-start lg:justify-start">
                  <button
                    ...
                    className={
                      disabled
                        ? 'opacity-30 flex items-center space-x-3 bg-primary px-6 py-3 text-white poppins rounded-full ring-red-300 focus:outline-none focus:ring-4  transition duration-700 hover:scale-105'
                        : 'flex items-center space-x-3 bg-primary px-6 py-3 text-white poppins rounded-full ring-red-300 focus:outline-none focus:ring-4  transition duration-700 hover:scale-105'
                    }
                    onClick={() => {
